...
public class MoleHex : MonoBehaviour
{
    ...
    private float speed = 18f; // speed at which the mole appears and hides
    ...
    public void OnTriggerEnter(Collider col)
    {
        ...
        {
            GameObject.Find("GameController").GetComponent<GameControllerHex>().score += 10;
            GameObject.Find("GameController").GetComponent<GameControllerHex>().SetQuestion();
            GameObject.Find("GameController").GetComponent<GameControllerHex>().SetAnswers();
