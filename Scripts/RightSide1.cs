...
public class RightSide1 : MonoBehaviour {
    ...
    private void OnTriggerEnter(Collider col)
    {
        ...
        //{
        if (!occupied && col.GetComponent<Cube>().shouldBePlaced == 2)
        {
            col.GetComponent<Cube>().hasBeenPlaced2 = true;
        ...
        else if (!occupied && col.GetComponent<Cube>().shouldBePlaced != 2)
        {
